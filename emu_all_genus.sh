...
emu combine-outputs "$OUTPUT_ROOT" genus --split-tables --counts

# Also generate CSV for spreadsheet use
TSV_COMBINED="$OUTPUT_ROOT/emu-combined-genus.tsv"
CSV_COMBINED="$OUTPUT_ROOT/emu-combined-genus.csv"
